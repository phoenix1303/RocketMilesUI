...
public class FLow01HomePage {
    ...
    public void homePageBasicElementsFlow(WebDriver driver) throws InterruptedException 
    {
    	...
    	System.out.println("[LOGGING]---------Asserting basic element of the home page");
    	...
    	System.out.println("[LOGGING]---------Presence of basic element on the home page was asserted sucessfully"); 
     }
    		...
    		int NumberOfGuests, int NumberOfRooms) throws InterruptedException 
    {
    	...
    	System.out.println("[LOGGING]---------Picking following rewards program - "+rewardsProgram);
    	...
    	System.out.println("[LOGGING]---------Setting up CheckIn date");
    	page01.homepageRocketMilesCheckInDate(driver).click();
    	System.out.println("[LOGGING]---------Determining exact CheckIn date");
    	...
    	System.out.println("[LOGGING]---------Exact checkIn date - "+year+"/"+month+"/"+day);
    	...
    	System.out.println("[LOGGING]---------Setting up CheckOut date");
    	page01.homepageRocketMilesCheckOutDate(driver).click();
    	System.out.println("[LOGGING]---------Determining exact CheckOut date");
    	...
    	System.out.println("[LOGGING]---------Exact CheckOut date - "+year+"/"+month+"/"+day);
    	...
    	System.out.println("[LOGGING]---------Setting up number of Guests as - "+ NumberOfGuests);
    	...
    	System.out.println("[LOGGING]---------Setting up number of Rooms as - "+ NumberOfRooms);
    	...
    	System.out.println("[LOGGING]---------Searching...");
    	...
    	System.out.println("[LOGGING]---------On Results page now");
     }
