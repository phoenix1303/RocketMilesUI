...
public class FLow01HomePage{
    		...
    		int NumberOfGuests, int NumberOfRooms) throws InterruptedException 
    {
    	...
    	int month = Integer.valueOf(CheckInDate.substring(4, 5));
    	int day = Integer.valueOf(CheckInDate.substring(5));
    	System.out.println("Exact checkIn date - "+year+"/"+month+"/"+day);
    	util.WaitForElementVisible(page01.homepageRocketMilesCalendarStartDate(driver, year, month, day), 20);
    	page01.homepageRocketMilesCalendarStartDate(driver, year, month, day).click();
    	...
    	month = Integer.valueOf(CheckOutDate.substring(4, 5));
    	day = Integer.valueOf(CheckOutDate.substring(5));
    	System.out.println("Exact CheckOut date - "+year+"/"+month+"/"+day);
    	util.WaitForElementVisible(page01.homepageRocketMilesCalendarEndDate(driver, year, month, day), 20);
    	page01.homepageRocketMilesCalendarEndDate(driver, year, month, day).click();
